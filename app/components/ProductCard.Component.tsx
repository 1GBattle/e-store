...
export default function ProductCard({product}: ProductCardProps) {
    return (
        <Link href={`/products/${product.id}`}
            ...
            <Image className='w-full h-3/5 rounded' src={product.picUrl} alt={product.name} width={100}
                   height={100}
                   priority/>
            ...
            <div className='p-1'>
                ...
                <p className='text-lg font-semibold text-center'>${product.price / 100 + 100}</p>
